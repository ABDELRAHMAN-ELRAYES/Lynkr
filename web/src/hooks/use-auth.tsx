      ...
      if (response.success) {
        ...
        if (fetchedUser.role === 'PENDING_PROVIDER') {
          return {
            success: true,
            user: fetchedUser,
            message: "Your provider application is under review. You'll be notified once approved.",
          };
        }
        ...
        if (fetchedUser.role === 'REJECTED_PROVIDER') {
          return {
            success: true,
            user: fetchedUser,
            message: "Your provider application was not approved. Please contact support for more information.",
          };
        }
