              ...
              <div className="relative">
                {isPreviewMode ? (
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-4 border border-gray-300 border-t-0 rounded-b-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none text-sm leading-relaxed font-mono"
                    rows={8}
              ...
              >
                ...
                <p className="text-sm text-gray-600 mb-4">
                  <button
                    ...
                    className="font-semibold text-blue-600 cursor-pointer hover:text-blue-700 underline"
                  >
                    Choose files
                  </button>{" "}
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                <button
                  ...
                  className="px-4 py-2 text-xs font-medium border border-gray-300 rounded-full hover:bg-white hover:shadow-sm transition-all"
                >
                  ASAP
                </button>
                <button
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-600 mt-2 leading-relaxed">
                    ...
                    and IP rights.
                    <button className="text-blue-600 underline cursor-pointer ml-1 hover:text-blue-700 font-medium">
                      View NDA
                    </button>
                  </p>
                </div>
            ...
            <div className="flex flex-col gap-4 pt-6 border-t border-gray-200">
              <div className="flex gap-4">
                <Button
                  onClick={close}
                  className="flex-1 px-6 py-3 text-sm font-medium text-gray-600 border-2 border-gray-300 rounded-lg bg-white hover:bg-white hover:border-gray-400 transition-all"
                >
                  Cancel
                </Button>
                <Button
                  className="flex-1 px-6 py-3 text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all shadow-lg hover:shadow-xl"
