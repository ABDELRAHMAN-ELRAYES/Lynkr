...
import { userService, UserResponse } from "@/services/api";
import { profileService, ProfileRequestWithFullData } from "@/services/api/profileService";

import { sidebarItems, notificationsData, ordersData, paymentsData } from "./data/mockData";
